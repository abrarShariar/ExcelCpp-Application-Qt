...
const char *location="../Cpp/CustomerDetails";
    DIR *dir;
    struct dirent *ent;
    int index=0;
    string fileName;
...
string getBillsFileName(){
    const char *location="../Cpp/CustomerBills";
    DIR *dir;
    struct dirent *ent;
    int index=0;
    string fileName;
...
vector<string>getCustomersDetails(string fileName){
    ...
    string location="../Cpp/CustomerDetails/"+fileName;
...
vector<string>getCustomersBills(string fileName){
    ...
    string location="../Cpp/CustomerBills/" + fileName;
    ifstream read;
    read.open(location);
...
int main(){
    ...
    ofstream write;
    write.open("..\\release\\Output\\data.csv");
